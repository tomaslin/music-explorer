...
export const MinimalToolbar: React.FC<MinimalToolbarProps> = ({
  onOpenSettings, isPlaying, onPlayPause, onRestart,
  ...
  <div className="shrink-0 border-t border-stone-800 bg-stone-950 text-stone-200 px-3 py-2 z-30">
    <div className="mx-auto max-w-[1800px] flex items-center justify-between gap-3">
      <div className="flex items-center gap-2">
        ...
        <button onClick={onPlayPause} aria-label={isPlaying ? 'Stop exercise' : 'Play exercise'} className={`flex items-center gap-2 px-7 py-3.5 rounded-xl font-bold text-base shadow-lg ${isPlaying ? 'bg-amber-500 text-stone-950' : 'bg-stone-800 hover:bg-stone-700 text-white'}`}>
